...
class Owner {
  ...
  factory Owner.fromJson(Map<String, dynamic> json) => Owner(
        ...
        gistsUrl: json["gists_url"] == null
            ? null
            : gistsUrlValues.map![json["gists_url"]],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "gists_url":
            gistsUrl == null ? null : gistsUrlValues.reverse![gistsUrl],
...
enum GistsUrl { HTTPS_API_GITHUB_COM_USERS_HASANABBASSORATHIYA_GISTS_GIST_ID }

final gistsUrlValues = EnumValues({
  "https://api.github.com/users/hasanabbassorathiya/gists{/gist_id}":
      GistsUrl.HTTPS_API_GITHUB_COM_USERS_HASANABBASSORATHIYA_GISTS_GIST_ID
});

enum Login { HASANABBASSORATHIYA }

final loginValues =
    EnumValues({"hasanabbassorathiya": Login.HASANABBASSORATHIYA});

enum NodeId { MDQ6_VX_NLCJ_Q4_M_TGX_O_TK1 }

final nodeIdValues =
    EnumValues({"MDQ6VXNlcjQ4MTgxOTk1": NodeId.MDQ6_VX_NLCJ_Q4_M_TGX_O_TK1});
